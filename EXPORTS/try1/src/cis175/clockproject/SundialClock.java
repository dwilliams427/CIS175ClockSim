...
/**
 * concrete class descended from Clock and NaturalClock with ClockInterface.
 *
...
public class SundialClock extends NaturalClock {
    ...
    public SundialClock(CLOCK_TYPE type, long initialTime, double driftPerSecond, String clockName) {
