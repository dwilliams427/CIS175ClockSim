...
/**
 * concrete class descended from Clock and DigitalClock with ClockInterface.
 *
...
public class WristClock extends DigitalClock {
    ...
    public WristClock(CLOCK_TYPE type, long initialTime, double driftPerSecond, String clockName) {
