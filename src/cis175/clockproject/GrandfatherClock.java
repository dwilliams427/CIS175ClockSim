...
/**
 * concrete class descended from Clock and MechanicalClock with ClockInterface.
 *
...
public class GrandfatherClock extends MechanicalClock {
	...
	public GrandfatherClock(CLOCK_TYPE type, long initialTime, double driftPerSecond, String clockName) {
